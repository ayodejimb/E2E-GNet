...
from E2E_models.E2E_UI_RigidNet_D import RigidNet
from E2E_models.E2E_UI_NonRigidNet_D import NonRigidNet
np.random.seed(42)
...
for ex in range(1,11):
    ...
    # *** Compute the mean of each transform for all the folds. ***
