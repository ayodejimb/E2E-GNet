...
from E2E_models_contribution_ablation.E2E_RigidNet120_with_trans_layer import RigidNet120
from E2E_models_contribution_ablation.E2E_NonRigidNet120_with_trans_layer import NonRigidNet120
...
for m in options:
    ...
    for r in range(runs):
        ...
        if not math.isnan(accuracy) and accuracy >= 10:
            ...
            print('Run {} of {} does not converge, so skipping...'.format(r, m))
    print('Finsished Running for {}'.format(m))
    transform_acc.append(np.mean(acc))
