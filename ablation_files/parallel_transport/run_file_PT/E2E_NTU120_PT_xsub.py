...
from E2E_models_PT.E2E_RigidNet120 import RigidNet120
from E2E_models_PT.E2E_NonRigidNet120 import NonRigidNet120
...
for m in options:
    ...
    loss = []
    mod = m
    save_weights_dir = os.path.join('./models_w', mod)
...
print('Results (mean) of the transform layers on 10 runs are {}'.format(transform_acc))